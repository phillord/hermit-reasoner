...
public class GraphTest extends AbstractReasonerInternalsTest {
    ...
    public void testGraphMerging() throws Exception {
        DescriptionGraph graph = G(new String[] { "A", // 0
                "B", // 1
                "C", // 2
        }, new DescriptionGraph.Edge[] { E("R", 0, 1), E("R", 1, 2), }, new String[] { "A", "B", "C", });
    ...
    public void testGraph1() throws Exception {
        m_descriptionGraphs.add(G(new String[] { "A", // 0
                "B", // 1
                "C", // 2
                "A", // 3
        }, new DescriptionGraph.Edge[] { E("R", 0, 1), E("R", 3, 2), }, new String[] { "A", }));
    ...
    // "[[oprop conn] V W]"+
    // "] ["+
    // "[[desc P] V] [[oprop R] X V] [[desc LP] X] [[oprop S] X Y] [[desc RP] Y]
    // [[oprop R] Y W] [[desc P] W]"+
    // "]]"
    // );
    // addAxiom(
    // "[rule ["+
