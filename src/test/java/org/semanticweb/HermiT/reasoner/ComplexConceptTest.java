...
public class ComplexConceptTest extends AbstractReasonerTest {
    ...
    public void testConceptWithDatatypes() throws Exception {
        ...
        OWLClassExpression desc = df.getOWLObjectSomeValuesFrom(f,
                df.getOWLDataSomeValuesFrom(dp, df.getOWLDataOneOf(PL("abc", ""))));
    ...
    public void testJustifications() throws Exception {
        ...
        OWLClassExpression desc = df.getOWLObjectIntersectionOf(df.getOWLObjectOneOf(matt),
