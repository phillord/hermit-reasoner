 ...
 *
 */
package org.semanticweb.HermiT.datatypes.xmlliteral.keys.storage.implementations;
...
import org.semanticweb.HermiT.datatypes.xmlliteral.keys.storage.StorageResolverException;
import org.semanticweb.HermiT.datatypes.xmlliteral.keys.storage.StorageResolverSpi;
...
public class KeyStoreResolver extends StorageResolverSpi {
   ...
   public static void main(String unused[]) throws Exception {
      ...
      for (Iterator i = krs.getIterator(); i.hasNext(); ) {
         ...
         byte[] ski =
             org.semanticweb.HermiT.datatypes.xmlliteral.keys.content.x509.XMLX509SKI
               .getSKIBytesFromCert(cert);

         System.out.println(org.semanticweb.HermiT.datatypes.xmlliteral.utils.Base64.encode(ski));
      }
   }
}
