...
public class InternalNames {
    ...
    /**
     * Return a set of namespaces with both the contents of `n` and prefixes
    * for all internal concepts, including shorthands for internal nominal
    * concepts based on the declarations from 'n'.
     */
