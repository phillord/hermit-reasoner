...
//        return m_extensionManager.containsRoleAssertion(r,first, second); 
//    }
//    protected boolean isInLabel(LiteralConcept c, Node node) {
//        if (c.isAlwaysTrue()) return true;
//        if (c.isAlwaysFalse()) return false;
//        if (c instanceof AtomicConcept) {
//            return m_extensionManager.containsConceptAssertion((AtomicConcept)c,node);
//        } else {
//            return !m_extensionManager.containsConceptAssertion(((AtomicNegationConcept)c).getNegatedAtomicConcept(),node);
//        }
//    }
...
//    }
    ...
    public void assertionAdded(Concept concept,Node node,boolean isCore) {
        ...
        if (isCore || m_lastValidatedUnchangedNode!=null) updateNodeChange(node);
        validationInfoChanged(node);
    }
    public void assertionCoreSet(Concept concept,Node node) {
        m_directBlockingChecker.assertionAdded(concept,node,true);
        if (m_lastValidatedUnchangedNode!=null) updateNodeChange(node);
        validationInfoChanged(node);
    }
