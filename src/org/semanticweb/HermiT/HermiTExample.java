...
public class HermiTExample {
	...
	public static void main(String[] args) throws Exception {
		printSubsumptionHierarchyAsText("file:/Users/rob/HermiT/test/org/semanticweb/HermiT/tableau/res/pizza.xml");
        // HermiT hermit = new HermiT();
        // hermit.setLoaderType(LoaderType.KAON2);
        // hermit.loadOntology("file:/c:/pizza.xml");
...
//        SubsumptionHierarchy subsumptionHierarchy = new SubsumptionHierarchy(subsumptionChecker);
...
//        return buffer.toString();
    ...
    public String getSubsumptionHierarchyAsText(String physicalURI) throws Exception {
		DefaultOntologyResolver resolver = new DefaultOntologyResolver();
        ...
        DLOntology dlOntology = clausification.clausify(false,ontology,noDescriptionGraphs);
        ...
        Tableau tableau = new Tableau(null,existentialsExpansionStrategy,dlOntology,new HashMap<String,Object>());
    
        SubsumptionHierarchy.SubsumptionChecker checker=new TableauSubsumptionChecker(tableau);
        SubsumptionHierarchy subsumptionHierarchy = new SubsumptionHierarchy(checker);
