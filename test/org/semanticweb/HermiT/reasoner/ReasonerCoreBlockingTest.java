...
public class ReasonerCoreBlockingTest extends ReasonerTest {
    ...
    public void testExpansion() throws Exception {
        String axioms = "SubClassOf(:B ObjectSomeValuesFrom(:r :D)) "
                + "SubClassOf(owl:Thing ObjectMaxCardinality(1 :r :C))" + "SubClassOf(:D :C)"
                + "SubClassOf(:A ObjectSomeValuesFrom(ObjectInverseOf(:r) :B))" + "ClassAssertion(:C :a)"
                + "ClassAssertion(:A :a)";
    ...
    public void testWidmann2() throws Exception {
        ...
        // df.getOWLClass(IRI.create("file:/c/test.owl#p"));
        // OWLObjectProperty invr =
        // df.getOWLObjectProperty(IRI.create("file:/c/test.owl#r-"));
        //
        // OWLClassExpression desc = df.getOWLObjectSomeValuesFrom(invr,
    ...
    @Override
    public void testDependencyDisjunctionMergingBug() {
    ...
    public void testIanT6() throws Exception {
        ...
        // m_dataFactory.getOWLClass(IRI.create("file:/c/test.owl#c"));
        // OWLClassExpression d =
        // m_dataFactory.getOWLClass(IRI.create("file:/c/test.owl#d"));
        // OWLObjectProperty invr =
        // m_dataFactory.getOWLObjectProperty(IRI.create("file:/c/test.owl#r-"));
        // OWLObjectProperty invf =
        // m_dataFactory.getOWLObjectProperty(IRI.create("file:/c/test.owl#f-"));
        //
    ...
    public void testIanT9() throws Exception {
        ...
        //
        // OWLClassExpression itr =
        // m_dataFactory.getOWLClass(IRI.create("file:/c/test.owl#Infinite-Tree-Root"));
        // OWLClassExpression root =
        // m_dataFactory.getOWLClass(IRI.create("file:/c/test.owl#root"));
        // OWLObjectProperty descendant =
        // m_dataFactory.getOWLObjectProperty(IRI.create("file:/c/test.owl#descendant"));
        // OWLObjectProperty invsuccessor =
        // m_dataFactory.getOWLObjectProperty(IRI.create("file:/c/test.owl#successor-"));
        //
