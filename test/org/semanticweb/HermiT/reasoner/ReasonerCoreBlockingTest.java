...
//                + "SubClassOf(owl:Thing ObjectAllValuesFrom(ObjectInverseOf(:r) ObjectAllValuesFrom(ObjectInverseOf(:r) ObjectAllValuesFrom(:s ObjectAllValuesFrom(ObjectInverseOf(:s) :C))))) ";
...
//        OWLClassExpression p = df.getOWLClass(IRI.create(NS+"p"));
...
//         assertABoxSatisfiable(false);
//         OWLDataFactory df = OWLManager.createOWLOntologyManager().getOWLDataFactory();
//         OWLClassExpression D = df.getOWLClass(IRI.create(NS+"D"));
//         OWLClassExpression E = df.getOWLClass(IRI.create(NS+"E"));
//         OWLObjectProperty r = df.getOWLObjectProperty(IRI.create(NS+"r"));
...
//         assertABoxSatisfiable(false);
//         OWLDataFactory df = OWLManager.createOWLOntologyManager().getOWLDataFactory();
//         OWLClassExpression C = df.getOWLClass(IRI.create(NS+"C"));
//         OWLClassExpression D = df.getOWLClass(IRI.create(NS+"D"));
//         OWLObjectProperty r = df.getOWLObjectProperty(IRI.create(NS+"r"));
//         OWLObjectProperty s = df.getOWLObjectProperty(IRI.create(NS+"s"));
...
//          assertABoxSatisfiable(false);
//          OWLDataFactory df = OWLManager.createOWLOntologyManager().getOWLDataFactory();
//          OWLClassExpression A = df.getOWLClass(IRI.create(NS+"A"));
//          OWLObjectProperty r = df.getOWLObjectProperty(IRI.create(NS+"r"));
//          OWLObjectPropertyExpression invr = df.getOWLObjectInverseOf(r);
...
//         assertABoxSatisfiable(false);
//         OWLDataFactory df = OWLManager.createOWLOntologyManager().getOWLDataFactory();
//         OWLClassExpression p1 = df.getOWLClass(IRI.create(NS+"p1"));
//         OWLClassExpression p2 = df.getOWLClass(IRI.create(NS+"p2"));
//         OWLClassExpression p3 = df.getOWLClass(IRI.create(NS+"p3"));
//         OWLObjectProperty r = df.getOWLObjectProperty(IRI.create(NS+"r"));
//
...
////         OWLDataFactory df = OWLManager.createOWLOntologyManager().getOWLDataFactory();
////         OWLClassExpression a = df.getOWLClass(IRI.create(NS+"a"));
////         OWLObjectProperty invr = df.getOWLObjectProperty(IRI.create(NS+"r-"));
////         OWLObjectProperty invf = df.getOWLObjectProperty(IRI.create(NS+"f-"));
////      
...
//         createReasoner();
//         assertABoxSatisfiable(false);
////         OWLClassExpression c = m_dataFactory.getOWLClass(IRI.create(NS+"c"));
////         OWLClassExpression d = m_dataFactory.getOWLClass(IRI.create(NS+"d"));
////         OWLObjectProperty invr = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"r-"));
////         OWLObjectProperty invf = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"f-"));
////         
...
//         StringBuffer buffer=new StringBuffer();
//         buffer.append("TransitiveObjectProperty(:r)");
//         buffer.append("ClassAssertion(ObjectIntersectionOf(:p1 ObjectSomeValuesFrom(:r ObjectSomeValuesFrom(:r ObjectIntersectionOf(:p1 ObjectAllValuesFrom(ObjectInverseOf(:r) ObjectComplementOf(:p1)))))) :a)");
//         loadOntologyWithAxioms(buffer.toString());
//         createReasoner();
//
////         OWLClassExpression p1=m_dataFactory.getOWLClass(IRI.create(NS+"p1"));
...
//         
//         OWLClassExpression p1 = m_dataFactory.getOWLClass(IRI.create(NS+"p1"));
//         OWLObjectProperty f = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"f"));
//         OWLObjectProperty invf = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"f-"));
//         
//         OWLClassExpression desc;
...
//         
//         
//         OWLClassExpression p = m_dataFactory.getOWLClass(IRI.create(NS+"p"));
//         OWLObjectProperty r = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"r"));
//         OWLObjectProperty invr = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"r-"));
//         OWLObjectProperty r1 = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"r1"));
//         
//         OWLClassExpression desc;
...
//         loadOntologyWithAxioms(buffer.toString());
//         createReasoner();
//         assertSatisfiable(NS+"Infinite-Tree-Root",true);
//     }
...
//         assertABoxSatisfiable(false);
//         
////         OWLClassExpression itr = m_dataFactory.getOWLClass(IRI.create(NS+"Infinite-Tree-Root"));
////         OWLClassExpression root = m_dataFactory.getOWLClass(IRI.create(NS+"root"));
////         OWLObjectProperty descendant = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"descendant"));
////         OWLObjectProperty invsuccessor = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"successor-"));
////         
...
//         OWLObjectProperty f = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"f"));
//         OWLObjectProperty invf = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"f-"));
//         OWLObjectProperty f1 = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"f1"));
//         OWLObjectProperty invf1 = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"f1-"));
//         OWLObjectProperty s= m_dataFactory.getOWLObjectProperty(IRI.create(NS+"s"));
//         OWLObjectProperty invs= m_dataFactory.getOWLObjectProperty(IRI.create(NS+"s-"));
//         
//         OWLClassExpression desc;
//         desc = m_dataFactory.getOWLObjectIntersectionOf(
...
//         
//         OWLClassExpression p = m_dataFactory.getOWLClass(IRI.create(NS+"p"));
//         OWLClassExpression q = m_dataFactory.getOWLClass(IRI.create(NS+"q"));
//         OWLObjectProperty s = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"s"));
//         OWLObjectProperty r = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"r"));
//         OWLObjectProperty invr = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"r-"));
//         
...
//         
//                  
//         OWLClassExpression a = m_dataFactory.getOWLClass(IRI.create(NS+"a"));
//         OWLClassExpression a1 = m_dataFactory.getOWLClass(IRI.create(NS+"a1"));
//         OWLClassExpression a2 = m_dataFactory.getOWLClass(IRI.create(NS+"a2"));
//         OWLClassExpression a3a = m_dataFactory.getOWLClass(IRI.create(NS+"a3a"));
//         OWLClassExpression a3b = m_dataFactory.getOWLClass(IRI.create(NS+"a3b"));
//         OWLClassExpression a3c = m_dataFactory.getOWLClass(IRI.create(NS+"a3c"));
//         OWLClassExpression a3e = m_dataFactory.getOWLClass(IRI.create(NS+"a3e"));
//
...
//         
//         OWLClassExpression a = m_dataFactory.getOWLClass(IRI.create(NS+"a"));
//         OWLClassExpression b = m_dataFactory.getOWLClass(IRI.create(NS+"b"));
//         OWLClassExpression c = m_dataFactory.getOWLClass(IRI.create(NS+"c"));
//
...
//         
//         OWLClassExpression p1 = m_dataFactory.getOWLClass(IRI.create(NS+"p1"));
//         OWLClassExpression p2 = m_dataFactory.getOWLClass(IRI.create(NS+"p2"));
//         OWLObjectProperty f1 = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"f1"));
//         OWLObjectProperty f2 = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"f2"));
//         OWLObjectProperty f3 = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"f3"));
//         
//         OWLClassExpression desc = m_dataFactory.getOWLObjectIntersectionOf(
...
//        
//
//        OWLClassExpression c1 = m_dataFactory.getOWLClass(IRI.create(NS+"c1"));
//        OWLClassExpression c2 = m_dataFactory.getOWLClass(IRI.create(NS+"c2"));
//        OWLObjectProperty rx3 = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"rx3"));
//        OWLObjectProperty rx4 = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"rx4"));
//        OWLObjectProperty rx3a = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"rx3a"));
//        OWLObjectProperty rx4a = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"rx4a"));
//
...
//         OWLClassExpression c = m_dataFactory.getOWLClass(IRI.create(NS+"c"));
//         OWLClassExpression d = m_dataFactory.getOWLClass(IRI.create(NS+"d"));
//         OWLClassExpression e = m_dataFactory.getOWLClass(IRI.create(NS+"e"));
//         OWLObjectProperty r = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"r"));
//         
//         OWLClassExpression desc = m_dataFactory.getOWLObjectIntersectionOf(
...
//         OWLClassExpression p = m_dataFactory.getOWLClass(IRI.create(NS+"p"));
//         OWLObjectProperty r1 = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"r1"));
//         OWLObjectProperty r2 = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"r2"));
//         
...
//         OWLClassExpression C = m_dataFactory.getOWLClass(IRI.create(NS+"C"));
//         OWLObjectProperty R = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"R"));
//         OWLObjectProperty P = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"P"));
...
//         OWLClassExpression c1 = m_dataFactory.getOWLClass(IRI.create(NS+"c1"));
//         OWLClassExpression c2 = m_dataFactory.getOWLClass(IRI.create(NS+"c2"));
//         OWLClassExpression c3 = m_dataFactory.getOWLClass(IRI.create(NS+"c3"));
//         OWLClassExpression c4 = m_dataFactory.getOWLClass(IRI.create(NS+"c4"));
//         OWLClassExpression c5 = m_dataFactory.getOWLClass(IRI.create(NS+"c5"));
//         OWLClassExpression c6 = m_dataFactory.getOWLClass(IRI.create(NS+"c6"));
//         OWLClassExpression c7 = m_dataFactory.getOWLClass(IRI.create(NS+"c7"));
//         OWLClassExpression c8 = m_dataFactory.getOWLClass(IRI.create(NS+"c8"));
//         OWLClassExpression c9 = m_dataFactory.getOWLClass(IRI.create(NS+"c9"));
//         OWLClassExpression c10 = m_dataFactory.getOWLClass(IRI.create(NS+"c10"));
//         OWLClassExpression c11 = m_dataFactory.getOWLClass(IRI.create(NS+"c11"));
//         OWLClassExpression c12 = m_dataFactory.getOWLClass(IRI.create(NS+"c12"));
//         OWLClassExpression c13 = m_dataFactory.getOWLClass(IRI.create(NS+"c13"));
//         OWLClassExpression c14 = m_dataFactory.getOWLClass(IRI.create(NS+"c14"));
//         OWLClassExpression c15 = m_dataFactory.getOWLClass(IRI.create(NS+"c15"));
//         OWLClassExpression c16 = m_dataFactory.getOWLClass(IRI.create(NS+"c16"));
//         OWLClassExpression c17 = m_dataFactory.getOWLClass(IRI.create(NS+"c17"));
//         OWLClassExpression c18 = m_dataFactory.getOWLClass(IRI.create(NS+"c18"));
//         OWLClassExpression d = m_dataFactory.getOWLClass(IRI.create(NS+"d"));
//         OWLObjectProperty r = m_dataFactory.getOWLObjectProperty(IRI.create(NS+"r"));
//         
//         OWLClassExpression desc = m_dataFactory.getOWLObjectIntersectionOf(
...
//         createReasoner();
//         
//         assertSubsumedBy(NS+"A",NS+"B",true);
//     }
//     
...
//         createReasoner();
//         
//         assertSatisfiable(NS+"test",false);
//     }
//     
...
//         createReasoner();
//         
//         assertSatisfiable(NS+"test",true);
//     }
