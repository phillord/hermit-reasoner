...
public class AnyURITest extends AbstractReasonerTest {
    ...
    public void testInvalidAnyURILiterals() throws Exception {
        assertEquals(URI.create("http://bla.com/test"),
                DatatypeRegistry.parseLiteral("http://bla.com/test", XSD_ANY_URI));
        try {
    ...
    public void testLength_1() throws Exception {
        assertDRSatisfiable(true, DR("xsd:anyURI", "xsd:length", INT("2")), OO(AURI("ab")));
    }

    public void testLength_2() throws Exception {
        assertDRSatisfiable(false, DR("xsd:anyURI", "xsd:length", INT("3")), OO(AURI("ab")));
    }

    public void testLength_3() throws Exception {
        assertDRSatisfiable(true, DR("xsd:anyURI", "xsd:minLength", INT("2"), "xsd:maxLength", INT("6")),
                NOT(DR("xsd:anyURI", "xsd:minLength", INT("3"), "xsd:maxLength", INT("5"))), OO(AURI("ab")));
    }

    public void testLength_4() throws Exception {
        assertDRSatisfiable(true, DR("xsd:anyURI", "xsd:minLength", INT("2"), "xsd:maxLength", INT("6")),
                NOT(DR("xsd:anyURI", "xsd:minLength", INT("3"), "xsd:maxLength", INT("5"))), OO(AURI("abcdef")));
    }

    public void testLength_5() throws Exception {
        assertDRSatisfiable(false, DR("xsd:anyURI", "xsd:minLength", INT("2"), "xsd:maxLength", INT("6")),
                NOT(DR("xsd:anyURI", "xsd:minLength", INT("3"), "xsd:maxLength", INT("5"))), OO(AURI("abcde")));
    }

    public void testSize_1() throws Exception {
        assertDRSatisfiable(true, DR("xsd:anyURI", "xsd:length", INT("0")));
    }

    public void testSize_2() throws Exception {
        assertDRSatisfiable(false, 2, DR("xsd:anyURI", "xsd:length", INT("0")));
    }

    public void testSize_3() throws Exception {
        assertDRSatisfiable(false, DR("xsd:anyURI", "xsd:length", INT("0")), NOT(OO(AURI(""))));
    }

    public void testIntersection() throws Exception {
        assertDRSatisfiable(false, DR("xsd:anyURI", "xsd:minLength", INT("0")),
                NOT(DR("xsd:anyURI", "xsd:minLength", INT("1"))));
    }

    public void testPattern1_1() throws Exception {
        assertDRSatisfiable(true, DR("xsd:anyURI", "xsd:pattern", STR("ab(c+)")), OO(AURI("abc"), AURI("abbb")));
    }

    public void testPattern1_2() throws Exception {
        assertDRSatisfiable(false, 2, DR("xsd:anyURI", "xsd:pattern", STR("ab(c+)")), OO(AURI("abc"), AURI("abbb")));
    }

    public void testPattern2_1() throws Exception {
        assertDRSatisfiable(true, 3, DR("xsd:anyURI", "xsd:pattern", STR("ab(c|d|e)")));
    }

    public void testPattern2_2() throws Exception {
        assertDRSatisfiable(false, 4, DR("xsd:anyURI", "xsd:pattern", STR("ab(c|d|e)")));
    }

    public void testPattern3() throws Exception {
        assertDRSatisfiable(false, DR("xsd:anyURI", "xsd:pattern", STR("ab(c|d|e)")),
                NOT(OO(AURI("abc"), AURI("abd"), AURI("abe"))));
    }

    public void testPatternAndLength1_1() throws Exception {
        assertDRSatisfiable(true, DR("xsd:anyURI", "xsd:pattern", STR("ab(c+)"), "xsd:length", INT("5")));
    }
    ...
    public void testPatternAndLength1_3() throws Exception {
        assertDRSatisfiable(true, DR("xsd:anyURI", "xsd:pattern", STR("ab(c+)"), "xsd:minLength", INT("4")),
                NOT(OO(AURI("abcc"), AURI("abccc"))));
    }
    ...
    public void testPatternAndLength3() {
        ValueSpaceSubset subset = subset("xsd:pattern", STR_C("ab(c+)"), "xsd:minLength", INT_C("5"), "xsd:maxLength",
                INT_C("10"));
        ...
        assertContainsAll(values, URI.create("abccc"), URI.create("abcccc"), URI.create("abccccc"),
                URI.create("abcccccc"), URI.create("abccccccc"), URI.create("abcccccccc"));
    }

    public void testPatternComplement1_1() throws Exception {
        assertDRSatisfiable(true, 3, DR("xsd:anyURI", "xsd:pattern", STR("ab(c*)")),
                NOT(DR("xsd:anyURI", "xsd:minLength", INT("5"))));
    }

    public void testPatternComplement1_2() throws Exception {
        assertDRSatisfiable(false, 4, DR("xsd:anyURI", "xsd:pattern", STR("ab(c*)")),
                NOT(DR("xsd:anyURI", "xsd:minLength", INT("5"))));
    }

    public void testPatternComplement1_3() throws Exception {
        assertDRSatisfiable(false, DR("xsd:anyURI", "xsd:pattern", STR("ab(c*)")),
                NOT(DR("xsd:anyURI", "xsd:minLength", INT("5"))), NOT(OO(AURI("ab"), AURI("abc"), AURI("abcc"))));
    }
