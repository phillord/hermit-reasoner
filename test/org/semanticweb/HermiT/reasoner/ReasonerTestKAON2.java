...
public class ReasonerTestKAON2 extends AbstractOntologyTest {

    public ReasonerTestKAON2(String name) {
        super(name);
    }
    ...
    public void testHeinsohnTBox3c() throws Exception {
        ...
        assertSatisfiable(
                "[and [all t1 a] [atLeast 3 t1] [atMost 1 r] [atMost 1 s]]",
                false);
    }
    ...
    public void testHeinsohnTBox3cIrh() throws Exception {
        ...
        assertSatisfiable(
                "[and [all tt a] [atLeast 3 tt] [atMost 1 tt c] [atMost 1 tt d]]",
                false);
    }
    ...
    public void testHeinsohnTBox7() throws Exception {
        ...
        assertSubsumedBy("[and [all r [all r- a]] [some r owl:Thing]]", "a",
                true);
    }
    ...
    public void testIanT1() throws Exception {
        ...
        assertSatisfiable(
                "[and [some r p1] [some r p2] [some r p3] [atMost 2 r]]", false);
        assertSatisfiable("[some r- [and [some r p1] [atMost 1 r p1]]]", true);
        assertSatisfiable("[and p2 [some r- [and [some r p1] [atMost 1 r]]]]",
                false);
    }
    ...
    public void testIanT5() throws Exception {
        ...
        assertSatisfiable("[and [not a] [some f- a] [all r- [some f- a]]]",
                true);
    }
    ...
    public void testIanT6() throws Exception {
        ...
        assertSatisfiable("[and [not c] [some f- d] [all r- [some f- d]]]",
                false);
    }
    ...
    public void testIanT7() throws Exception {
        ...
        addAxiom("[objectFunctional f]");
        assertSatisfiable(
                "[and p1 [some r [some r [and p1 [all r- [not p1]]]]]]", false);
        assertSatisfiable(
    ...
    public void testIanT11() throws Exception {
        ...
        assertSatisfiable(
                "[and [not p] [atMost 1 r] [some r [all s- p]] [some s p]]",
                false);
    }
    ...
    public void testNominals3() throws Exception {
        ...
        assertInstanceOf("[some [inv S] [and A B [some R [and A B]]]]", "n",
                true);
    }
