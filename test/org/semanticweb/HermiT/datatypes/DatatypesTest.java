...
public class DatatypesTest extends AbstractReasonerTest {
    ...
    public void testDatatypeRestrictionIntegerNegated() throws Exception {
        ...
        assertFalse(drInteger.isFinite());
        for (DatatypeRestrictionInteger.Interval i : drInteger.getIntervals()) {
            assertTrue(i.getMinIncl().equals(new BigInteger("-1")));
            assertTrue(i.getMaxIncl().equals(new BigInteger("-5")));
        }
        ...
        for (DatatypeRestrictionInteger.Interval i : drInteger.getIntervals()) {
            assertTrue(i.getMinIncl().equals(new BigInteger("-1")));
            assertTrue(i.getMaxIncl().equals(new BigInteger("4")));
        }
    }
    ...
    public void testConjoinRanges1() {
        ...
        // to             |------...
        // results in     |------...
        DataRange dr1 = new DatatypeRestrictionInteger();
        dr1.addFacet(Facets.MIN_INCLUSIVE, "10");
        DataRange dr2 = new DatatypeRestrictionInteger();
    ...
    public void testConjoinTwoNegRanges1() {
        ...
        DataRange dr3 = new DatatypeRestrictionInteger();
        dr3.negate();
    ...
    public void testConjoinTwoNegRangesAndPositive() {
        ...
        dr3.addFacet(Facets.MIN_INCLUSIVE, "30"); // <= 29
        dr3.addFacet(Facets.MAX_INCLUSIVE, "40"); // or >= 41
        DataRange dr4 = new DatatypeRestrictionInteger();
