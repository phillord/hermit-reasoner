...
public class IntegersTest extends AbstractReasonerTest {
    ...
    public void testFinToBig() {
        ...
        dr1.addFacet(Facets.MIN_INCLUSIVE, "" + Long.MAX_VALUE);
        assertFalse(dr1.accepts(new DataConstant(DT.INTEGER, "" + (Long.MAX_VALUE - 1))));
        assertTrue(dr1.accepts(new DataConstant(DT.INTEGER, "" + Long.MAX_VALUE)));
        for (IntegerInterval i : dr1.getIntegerIntervals()) {
            assertTrue(i instanceof IntegerIntervalFin);
        }
        dr1.addFacet(Facets.MIN_EXCLUSIVE, "" + Long.MAX_VALUE);
        assertFalse(dr1.accepts(new DataConstant(DT.INTEGER, "" + Long.MAX_VALUE)));
        assertTrue(dr1.accepts(new DataConstant(DT.INTEGER, "" + new BigInteger("" + Long.MAX_VALUE).add(BigInteger.ONE))));
        for (IntegerInterval i : dr1.getIntegerIntervals()) {
    ...
    public void testFinToBig2() {
        DatatypeRestrictionInteger dr1 = new DatatypeRestrictionInteger(DT.INTEGER);
        dr1.addFacet(Facets.MAX_INCLUSIVE, "" + Long.MIN_VALUE);
        assertFalse(dr1.accepts(new DataConstant(DT.INTEGER, "" + (Long.MIN_VALUE + 1))));
        assertTrue(dr1.accepts(new DataConstant(DT.INTEGER, "" + Long.MIN_VALUE)));
        for (IntegerInterval i : dr1.getIntegerIntervals()) {
            assertTrue(i instanceof IntegerIntervalFin);
        }
        dr1.addFacet(Facets.MAX_EXCLUSIVE, "" + Long.MIN_VALUE);
        assertFalse(dr1.accepts(new DataConstant(DT.INTEGER, "" + Long.MIN_VALUE)));
        assertTrue(dr1.accepts(new DataConstant(DT.INTEGER, "" + new BigInteger("" + Long.MIN_VALUE).subtract(BigInteger.ONE))));
        for (IntegerInterval i : dr1.getIntegerIntervals()) {
            assertTrue(i instanceof IntegerIntervalBig);
        }
    }
    ...
    public void testConjoinDouble() {
        ...
        dr2.addFacet(Facets.MIN_INCLUSIVE, "11.11");
        CanonicalDataRange canonical = (CanonicalDataRange) dr1;
        canonical.conjoinFacetsFrom(dr2);
        assertTrue(canonical.isFinite());
        assertFalse(canonical.accepts(new DataConstant(dr1.getDatatype(), "11")));
    ...
    public void testConjoinDouble2() {
        ...
        dr1.addFacet(Facets.MIN_INCLUSIVE, "10.0");
        DataRange dr2 = new DatatypeRestrictionDouble(DT.DOUBLE);
        dr2.addFacet(Facets.MIN_INCLUSIVE, "11.11"); // >= 12
        dr2.addFacet(Facets.MAX_EXCLUSIVE, "15.1");  // <= 15
        CanonicalDataRange canonical = (CanonicalDataRange) dr1;
    ...
    public void testConjoinDecimal2() {
        ...
        DataRange dr1 = new DatatypeRestrictionInteger(DT.INTEGER);
        dr1.addFacet(Facets.MIN_INCLUSIVE, "0");
        dr1.addFacet(Facets.MAX_INCLUSIVE, "5");
        DataRange dr2 = new DatatypeRestrictionOWLRealPlus(DT.DECIMAL);
        dr2.addFacet(Facets.MIN_INCLUSIVE, "0.1"); // >= 1
        dr2.addFacet(Facets.MAX_INCLUSIVE, "2.0");  // <= 2
        CanonicalDataRange canonical = (CanonicalDataRange) dr1;
        canonical.conjoinFacetsFrom(dr2); // >= 1 and <= 2
        assertTrue(canonical.isFinite());
        assertFalse(canonical.accepts(new DataConstant(dr1.getDatatype(), "0")));
        assertTrue(canonical.accepts(new DataConstant(dr1.getDatatype(), "1")));
        assertTrue(canonical.accepts(new DataConstant(dr1.getDatatype(), "2")));
        assertFalse(canonical.accepts(new DataConstant(dr1.getDatatype(), "3")));
        assertTrue(((DatatypeRestrictionInteger)canonical).getIntegerIntervals().size() == 1);
        assertTrue(canonical.getEnumerationSize().equals(new BigInteger("2")));
    }
