...
public class ClausificationOWLTest extends AbstractOWLOntologyTest {
    static {
        System.setProperty("entityExpansionLimit",String.valueOf(Integer.MAX_VALUE));
    }
    public ClausificationOWLTest(String name) {
        super(name);
    }
    public void testBasicClausification() throws Exception {
        assertClausification("res/clausification-1-input.xml","res/clausification-1-OWL-control.txt");
    }
    public void testNominalClausification1() throws Exception {
        assertClausification("res/clausification-2-input.xml","res/clausification-2-OWL-control.txt");
    }
    public void testNominalClausification2() throws Exception {
        assertClausification("res/clausification-3-input.xml","res/clausification-3-OWL-control.txt");
    }
    public void testNominalClausification3() throws Exception {
        assertClausification("res/clausification-4-input.xml","res/clausification-4-OWL-control.txt");
    }
    public void testNominalClausification4() throws Exception {
        assertClausification("res/clausification-5-input.xml","res/clausification-5-OWL-control.txt");
    }
    public void testAsymmetryClausification() throws Exception {
        assertClausification("res/asymmetric-1-input.xml","res/asymmetric-1-OWL-control.txt");
    }
    public void testExistsSelfClausification() throws Exception {
        assertClausification("res/self-1-input.owl","res/self-1-OWL-control.txt");
    }
    public void testExistsSelf2Clausification() throws Exception {
        assertClausification("res/self-2-input.owl","res/self-2-OWL-control.txt");
    }
    ...
    protected void assertClausification(String ontologyResource,String controlResource) throws Exception {
        assertDLClauses(getOWLOntologyFromResource(ontologyResource),getControl(controlResource));
    }
    protected void assertDLClauses(OWLOntology ontology,String... control) throws Exception {
        OwlClausification clausifier = new OwlClausification();
        OWLOntologyManager manager = OWLManager.createOWLOntologyManager();
        OWLDataFactory factory = manager.getOWLDataFactory();
        Set<DescriptionGraph> noDescriptionGraphs = Collections.emptySet();
        DLOntology dlOntology=clausifier.clausify(false, ontology, factory, noDescriptionGraphs);
