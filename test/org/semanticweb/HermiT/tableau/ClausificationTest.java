...
public class ClausificationTest extends AbstractHermiTTest {
    ...
    public void testBasicClausification() throws Exception {
        assertClausification("res/clausification-1-input.xml","res/clausification-1-control.txt");
    }
    public void testNominalClausification1() throws Exception {
        assertClausification("res/clausification-2-input.xml","res/clausification-2-control.txt");
    }
    public void testNominalClausification2() throws Exception {
        assertClausification("res/clausification-3-input.xml","res/clausification-3-control.txt");
    }
    public void testNominalClausification3() throws Exception {
        assertClausification("res/clausification-4-input.xml","res/clausification-4-control.txt");
    }
    public void testNominalClausification4() throws Exception {
        assertClausification("res/clausification-5-input.xml","res/clausification-5-control.txt");
    }
    protected void assertClausification(String ontologyResource,String controlResource) throws Exception {
        assertDLClauses(getOntologyFromResource(ontologyResource),getControl(controlResource));
    }
    ...
    protected void assertDLClauses(Ontology ontology,String... control) throws Exception {
        ...
        DLOntology dlOntology=clausification.clausify(ontology,true,new HashSet<DescriptionGraph>());
